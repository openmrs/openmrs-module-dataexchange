...
public class DataExporter {
	...
	class ExportDataWork implements Work {
		String filePath;
		
		public ExportDataWork(String filePath)
		{
		...
		public void execute(Connection jdbcConnection) throws SQLException {
			...
			try {
				...
				exportConcepts(connection, filePath, conceptIds);
	...
	@Transactional
	public void exportConcepts(DatabaseConnection connection, String filePath, Set<Integer> ids) throws IOException {
	...
	public void exportAllConcepts(String filePath) throws IOException {
		sessionFactory.getCurrentSession().doWork(new ExportDataWork(filePath));
	}
